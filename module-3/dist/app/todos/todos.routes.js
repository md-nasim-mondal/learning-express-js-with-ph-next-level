...
exports.todosRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = yield mongodb_1.client.db("nextLevelTodosDB");
...
exports.todosRouter.put("/update-todo/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedTodo = collection.updateOne(filter, {
        $set: { title, description, priority, isCompleted },
    }, { upsert: true });
    res.json(updatedTodo);
}));
exports.todosRouter.get("/delete-todo/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const db = yield mongodb_1.client.db("nextLevelTodosDB");
    const collection = yield db.collection("todos");
